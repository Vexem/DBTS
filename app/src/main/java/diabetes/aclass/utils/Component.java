...
//    public static final String API_BASE = "http://192.168.1.7/";
    public static final String API_BASE = "http://192.168.1.3/";
    ...
    public static final String API_GET_LASTMONTH_MEASUREMENT_BYID = API_BASE + "measurements/patientmeasord?patient_id=";
